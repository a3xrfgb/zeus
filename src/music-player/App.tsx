...
import { Route, MemoryRouter as Router, Routes, useLocation } from 'react-router-dom';
...
function App() {
  return (
    <ConfigProvider theme={{ token: { fontFamily: 'SpotifyMixUI, Inter, system-ui, sans-serif' } }}>
